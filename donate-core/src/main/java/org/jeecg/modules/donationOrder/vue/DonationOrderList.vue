  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'payMethod',text:'支付方式',dictCode:'pay_method'})
        fieldList.push({type:'int',value:'status',text:'支付状态',dictCode:''})
        fieldList.push({type:'Text',value:'message',text:'支付留言',dictCode:''})
        fieldList.push({type:'string',value:'money',text:'捐赠总额',dictCode:''})
