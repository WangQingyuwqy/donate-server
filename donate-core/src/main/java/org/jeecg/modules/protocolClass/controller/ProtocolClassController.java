...
@Api(tags="协议项目分类")
@RestController
@RequestMapping("/protocolClass/protocolClass")
@Slf4j
public class ProtocolClassController extends JeecgController<ProtocolClass, IProtocolClassService> {
	@Autowired
	 ...
	 * @return
	 */
	@AutoLog(value = "协议项目分类-添加")
	@ApiOperation(value="协议项目分类-添加", notes="协议项目分类-添加")
	@PostMapping(value = "/add")
	public Result<?> add(@RequestBody ProtocolClass protocolClass) {
		protocolClassService.save(protocolClass);
