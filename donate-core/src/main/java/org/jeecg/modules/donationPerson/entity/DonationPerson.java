package org.jeecg.modules.donationPerson.entity;
...
@ApiModel(value="donation_person对象", description="捐赠人")
public class DonationPerson implements Serializable {
	...
	/**是否校友*/
	@Excel(name = "是否校友", width = 15)
    @ApiModelProperty(value = "是否校友")
    private java.lang.Integer isSchoolmate;
	/**专业*/
