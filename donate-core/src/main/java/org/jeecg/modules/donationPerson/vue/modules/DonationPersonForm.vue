        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="是否校友" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="isSchoolmate">
              <a-input-number v-model="model.isSchoolmate" placeholder="请输入是否校友" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/donationPerson/donationPerson/add",
          edit: "/donationPerson/donationPerson/edit",
          queryById: "/donationPerson/donationPerson/queryById"
        }
      }
    },
    computed: {
